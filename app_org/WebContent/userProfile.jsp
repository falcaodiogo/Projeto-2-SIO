...
<%@ page
	import="com.shashi.service.impl.*, com.shashi.service.*,com.shashi.beans.*, java.util.*,javax.servlet.ServletOutputStream,java.io.*"%><%@ page import="java.sql.Connection, java.sql.PreparedStatement, java.sql.SQLException" %>
<%@ page import="java.sql.Connection, java.sql.PreparedStatement, java.sql.SQLException" %>
<%@ page import="com.shashi.service.UserService, com.shashi.beans.UserBean" %>
<!DOCTYPE html>
<html>
<head>
