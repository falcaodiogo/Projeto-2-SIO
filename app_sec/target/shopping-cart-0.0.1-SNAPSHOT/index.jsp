...
<body style="background-color: #ffffff;">
	...
	String escapedSearch = StringEscapeUtils.escapeHtml4(search);
	String type = request.getParameter("type");
	String message = "All Products";
	if (search != null) {
		products = prodDao.searchAllProducts(escapedSearch);
		message = "Showing Results for '" + escapedSearch + "'";
	} else if (type != null) {
	...
	if (products.isEmpty()) {
		message = "No items found for the search '" + (escapedSearch != null ? escapedSearch : type) + "'";
		products = prodDao.getAllProducts();
	}
	%>
